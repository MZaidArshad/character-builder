  ...
  (
    ...
    useImperativeHandle(ref, () => ({
      exportPDF: async () => {
        ...
        console.log("character in pdf exporter:", character);
      },
    }));
            ...
            >
              ...
              <div className="pdf-section pdf-health-section">
                ...
                <div className="pdf-health-bar">
                  ...
                  <div className="pdf-health-item">
                    ...
                    <div className="pdf-health-note">
                      -1 AP for each stage of Wounded. Wound Threshold is
                      quarter of their total HP (rounded up).
                    </div>
                  </div>
              ...
              <div className="pdf-section">
                ...
                <div className="pdf-dice-section-para">
                  HOVER OVER DICE NAMES TO SET DICE QUANTITY. LEFT CLICK ICONS
                  TO ROLL. RIGHT CLICK ICONS TO ADD TO POOL.
                </div>
                <div
                  style={{
                    display: "flex",
